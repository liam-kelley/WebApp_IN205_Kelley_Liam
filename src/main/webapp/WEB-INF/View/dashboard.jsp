      ...
      <div class="row">
        ...
        <div class="col l4 s6">
          <div class="small-box bg-green">
            <div class="inner">
              <h3>$(livreCount)</h3> <!-- DONE : afficher le nombre de livres � la place de 27 -->
              <p>Livres</p>
            </div>
            <div class="icon">
        ...
        <div class="col l4 s6">
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3>$(empruntCount)</h3> <!-- DONE : afficher le nombre d'emprunts � la place de 1515 -->
              <p>Emprunts</p>
            </div>
            <div class="icon">
        ...
        <div class="container">
	        <div class="col s12">
	          ...
	          <table class="striped">
                ...
                <tbody id="results">
                  <c:forEach items="${listEmprunt}" var="emprunt" varStatus="loop">

                    <tr>
                      <td>${listLivre[loop.count - 1].titre}, <em>de ${listLivre[loop.count - 1].auteur}</em></td>
                      <td>${listMembre[loop.count - 1].prenom} ${listMembre[loop.count - 1].nom}</td>
